...
import flyingSprites from '../gfx/air-slug-flying-sprites.png';
...
class AirSlugView {
	...
	constructor(model){
		...
		this.flyingSprite = new SpriteSheet(
			flyingSprites, 
		...
		this.damageRadialAnimationCounter = 0;
	...
	render = () => {
		...
		this.flyingSprite.setDirection(this.model.state.direction);
		this.flyingSprite.setPosition(
			this.model.state.posX - GLOBALS.camera.posX, 
			this.model.state.posY - GLOBALS.camera.posY
		);
		this.flyingSprite.render();
